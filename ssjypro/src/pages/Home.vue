  ...
  <div class="home">
    ...
    <div class="major">
      <div class="major-top">
        <span></span>
        <p>招生专业</p>
        <router-link :to="{name:'major'}" target="_blank">更多 ></router-link>
      </div>
    ...
    <div class="campus">
      <div class="campus-top">
        <span></span>
        <p>校园展示</p>
        <router-link :to="{name:'campus'}" target="_blank">更多 ></router-link>
      </div>
      <ul>
...
export default {
  ...
  created() {
    ...
    // axios.post('http://ssjy.public.5151fw.com/api/category_article',qs.stringify(newsid))
    // .then(resp=>{
    //     ////console.log(resp)
