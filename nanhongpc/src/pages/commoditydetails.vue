  ...
  <div class="commoditydetails">
    ...
    <div class="det-eva">
      ...
      <div class="det detevabox" v-show="detevanum==0">
        <div class="detinfos scorll" id="deinfos" v-html="goodsinfo.goods_info.goods_contents"></div>
      </div>
      <!-- 评价 -->
        ...
        <div class="evainfos scorll">
          <div class="eitop">
            <el-radio-group v-model="radio">
              <el-radio :label="3" @change="change">好评</el-radio>
              <el-radio :label="2" @change="change">中评</el-radio>
              <el-radio :label="1" @change="change">差评</el-radio>
            </el-radio-group>
            <div class="showpic">
...
export default {
  ...
  methods: {
    ...
    previewimg(items) {
      console.log(items);
      this.previewpic[0] = this.httpUrl + items;
    },
    // toeva() {
