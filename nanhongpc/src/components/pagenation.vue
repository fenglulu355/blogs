<template>
  <ul class="mo-paging">
    ...
    <!-- prev -->
    <li
      :class="['paging-item','curpage', 'paging-item--prev', {'paging-item--disabled' : index === 1}]"
      @click="prev"
    >上一页</li>
    ...
    <!-- next -->
    <li
      :class="['paging-item','curpage', 'paging-item--next', {'paging-item--disabled' : index === pages}]"
      @click="next"
    >下一页</li>
    <!-- last -->
    <li
...
.mo-paging {
  ...
  > .paging-item {
    ...
    &.paging-item--current {
      ...
      position: relative;
      z-index: 1;
      border-color: rgba(36, 130, 200, 1);
    }
  }
  .curpage {
