...
export default {
    ...
    created(){
        ...
        axios.post('http://ssjy.public.5151fw.com.php/index/api/category_show',qs.stringify(detailedid))
        .then(resp=>{
            console.log(resp)
            this.detailed = resp.data.data
        })
        axios.post('http://ssjy.public.5151fw.com.php/index/api/category_show',qs.stringify(policyid))
        .then(resp=>{
            console.log(resp)
