    ...
    <mt-tab-container v-model="seselected">
      ...
      <mt-tab-container-item id="2">
        <div class="survey-teachers">
          ...
          <div class="survey-teachers-bottom s-t-teshu" v-html="this.teachers.content"></div>
        </div>
      </mt-tab-container-item>
      <mt-tab-container-item id="3">
        <div class="survey-teachers">
          ...
          <div class="survey-teachers-bottom">
            <ul>
              <li v-for="item in honor" :key="item.id" @click="toArticle(item.id)">
                <div class="pic">
