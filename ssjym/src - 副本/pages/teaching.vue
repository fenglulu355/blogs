    ...
    <mt-tab-container v-model="seselected">
      <mt-tab-container-item id="1">
        <div class="teaching-teachers">
          ...
          <div class="teaching-teachers-bottom" v-html="teaching.content"></div>
        </div>
      ...
      <mt-tab-container-item id="2">
        <div class="teaching-teachers">
          ...
          <div class="teaching-teachers-bottom" v-html="this.security.content"></div>
        </div>
      </mt-tab-container-item>
      <mt-tab-container-item id="3">
        <div class="teaching-teachers">
          ...
          <div class="teaching-teachers-bottom" v-html="this.behavior.content"></div>
        </div>
      </mt-tab-container-item>
    </mt-tab-container>
  </div>
