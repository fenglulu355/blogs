    ...
    <div class="teaching">
        ...
        <mt-tab-container-item id="1">
            <div class="teaching-teachers">
                ...
                <div class="teaching-teachers-bottom"  v-html="teaching.content">
                </div>
            </div>
...
export default {
    ...
    created(){
        ...
        axios.post('http://ssjy.public.5151fw.com/index/api/category_show',qs.stringify(teachingid))
        .then(resp=>{
            console.log(resp)
            this.teaching = resp.data.data
        })
        axios.post('http://ssjy.public.5151fw.com/index/api/category_show',qs.stringify(securityid))
        .then(resp=>{
            console.log(resp)
            this.security = resp.data.data
        })
        axios.post('http://ssjy.public.5151fw.com/index/api/category_show',qs.stringify(behaviorid))
        .then(resp=>{
            console.log(resp)
