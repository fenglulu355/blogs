    ...
    <div class="home">
        <div class="contact">
            <div class="contact-top">
                <ul>
                    <li v-for="item in list" :key="item.id" @click="toUrl">
                        {{item.title}}
                    </li>
                </ul>
            </div>
            <div class="contact-bottom">
                <div class="contact-bottom-right">
                    <span><a :href="'tel:'+this.mobilea">点击电话：{{this.mobilea}}咨询</a></span>
                </div>
            </div>
        </div>
        <div class="major">
        ...
        <div class="information">
            ...
            <div class="information-bottom">
                ...
                <div class="button">
                    ...
                    <p><a href="https://tb.53kf.com/code/client/3a9d5a2b9d4fd553ae193d55dbb7cf064/2">在线咨询 学费 课程  就业</a></p>
                </div>
            </div>
        </div>
        <div class="campus">
            ...
            <ul>
                ...
                @click="toCampus"
                >
                    <div class="pic2"><img :src="host+item.thumb"></div>
                    <p>{{item.title}}</p>
                </li>
            </ul>
        ...
        <div class="news">
            ...
            <div class="news-bottom">
                <ul>
                    ...
                    v-for="item in news"
                    :key="item.id"
                    @click="toExamination(item.id)"
                    >
                        <a> {{item.title}}</a>
                        <a>{{item.create_time}}</a>
                    </li>
                </ul>
                <div class="online"><a href="https://tb.53kf.com/code/client/3a9d5a2b9d4fd553ae193d55dbb7cf064/2"><img src="../assets/comments.png">在线咨询 学费 课程  就业</a></div>
            </div>
        </div>
        <div class="tzgg">
            <div class="tzgg-top">
        ...
        <div class="sub">
            ...
            <div class="sub-bottom">
                <div class="sub-bottom-top">
                    学生姓名：<input class="ipt1" type="text" v-model="name">
                </div>
                <div class="sub-bottom-center">
                    联系电话：<input class="ipt2" type="text" v-model="mobile">
                </div>
...
export default {
    ...
    created(){
        ...
        axios.post('http://www.scsgmx.com/index.php/index/api/category_article',qs.stringify(campusid))
        .then(resp=>{
            ////console.log(resp)
        ...
        // .then(resp=>{
        //     ////console.log(resp)
        //     this.news = resp.data.data.data.splice(0,10)
        // })
        axios.post('http://www.scsgmx.com/index.php/index/api/category_article',qs.stringify(kxid))
        .then(resp=>{
            //// console.log(resp)
            this.news = resp.data.data.data
          //  console.log(this.news)
        })
        axios.post('http://www.scsgmx.com/index.php/index/api/category_article',qs.stringify(tzid))
        .then(resp=>{
            //// console.log(resp)
    ...
    methods:{
        ...
        subFrom(){
            ...
            axios.post('http://www.scsgmx.com/index.php/index/api/add_mobileEnroll',qs.stringify(pramas))
            .then(resp=>{
