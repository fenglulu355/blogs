...
export default {
    ...
    created(){
        ...
        axios.post('http://www.scsgmx.com/index.php/index/api/category_show',qs.stringify(contactid))
        .then(resp=>{
            console.log(resp)
            this.contact = resp.data.data
        })
        axios.post('http://www.scsgmx.com/index.php/index/api/category_show',qs.stringify(routeid))
        .then(resp=>{
            console.log(resp)
