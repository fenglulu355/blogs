    ...
    <div class="charge">
        ...
        <mt-tab-container-item id="1">
            <div class="examination-teachers">
                ...
                <div class="examination-teachers-bottom" v-html="this.detailed.content">
                </div>
            </div>
...
export default {
    ...
    created(){
        ...
        axios.post('http://www.scsgmx.com/index.php/index.php/index/api/category_show',qs.stringify(detailedid))
        .then(resp=>{
            console.log(resp)
            this.detailed = resp.data.data
        })
        axios.post('http://www.scsgmx.com/index.php/index.php/index/api/category_show',qs.stringify(policyid))
        .then(resp=>{
            console.log(resp)
